...
public class sinhVienCDCQ extends Nguoi {
    private double tdkt;
    private int smkt;
    ...
    public void nhapThongtin() {
        ...
        System.out.println("Nhập điểm thi kết thúc học phần:");
        try {
            dtkthp = Double.parseDouble(sc.nextLine());
        } catch (NumberFormatException e) {
            System.out.println("Lỗi: Điểm thi kết thúc học phần phải là số thực.");
        } catch (Exception e) {
            System.out.println("Lỗi nhập điểm thi kết thúc học phần: " + e.getMessage());
        }
    }
